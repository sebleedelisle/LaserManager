...
void LaserManager:: setup (int width, int height) {
	...
	parameters.add(pps.set("points per second", 80000, 5000, 100000));
...
void LaserManager::addLaserPolyline(const ofPolyline& line, ofColor col, float intens){
...
void LaserManager :: addLaserSVG(ofxSVG & svg, ofPoint pos, ofPoint scale, ofPoint rotation, ofPoint centreOffset, float intens ) {
